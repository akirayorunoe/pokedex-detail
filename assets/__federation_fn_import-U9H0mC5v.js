...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-DH43pKBw.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-B7djE2Bk.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query-Cru7rcq1.js', import.meta.url).href),import:true},'react-router-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-router-dom-B7QEBs6E.js', import.meta.url).href),import:true},'gh-pages':{get:()=>()=>__federation_import(new URL('__federation_shared_gh-pages-8tbFOgCc.js', import.meta.url).href),import:true}};
